...

{
  ...
  "sections": [
    {
      "name": <one of: "Summary" | "Experience" | "Projects" | "Skills" | "Education" | "Formatting">,
      "score": <integer 0-100>,
...
6. If a section (e.g. Education, Projects) is absent from the resume, still include it in "sections" with score 0, empty strengths/improvements arrays, and rewrite_suggestion set to "Section not found in resume."
